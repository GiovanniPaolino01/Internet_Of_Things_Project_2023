...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c1e458, const void *arg_0xb7c1e5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bcf8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a79840), 
int (*key_eq_fn)(void *arg_0xb7a79c88, void *arg_0xb7a79e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79489b8, int arg_0xb7948b10);
static double RandomUniform(void );
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void Project1C$Timer1$startPeriodicAt(uint32_t t0, uint32_t dt);
# 34 "Project1C.nc"
message_t Project1C$packet[1000];


uint16_t Project1C$subToTopic0[1000][8];
uint16_t Project1C$subToTopic1[1000][8];
uint16_t Project1C$subToTopic2[1000][8];
int Project1C$i[1000];

int Project1C$numSub[1000];


uint16_t Project1C$connections[1000][8];


static bool Project1C$Mysend(uint16_t address, message_t *p);
...
#line 158
static inline message_t *Project1C$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 426
static void Project1C$AMSend$sendDone(message_t *bufPtr, error_t error);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
#line 57
#line 55
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4345 {
  message_t * msg;
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void Project1C$Timer1$startPeriodicAt(uint32_t t0, uint32_t dt){
#line 114
...
#line 169
    {
      ...
      if (TOS_NODE_ID == 0) {
          ...
          if (__nesc_ntoh_uint16(rcm->type.nxdata) == 0) {
              sim_log_debug(158U, "timer", "TYPE 0: CONNECT message received------------------------------------------------------\n");

              Project1C$connections[sim_node()][__nesc_ntoh_uint16(rcm->nodeID.nxdata) - 1] = 1;

              rcm2 = (msg_t *)Project1C$Packet$getPayload(&Project1C$packet[sim_node()], sizeof(msg_t ));
              if (rcm2 == (void *)0) {
                  return bufPtr;
                }
              __nesc_hton_uint16(rcm2->type.nxdata, 1);

              sim_log_debug(159U, "timer", "PAN COORD tries to send CONNACK message\n");

              Project1C$Mysend(__nesc_ntoh_uint16(rcm->nodeID.nxdata), &Project1C$packet[sim_node()]);
            }
          else {
            if (Project1C$connections[sim_node()][__nesc_ntoh_uint16(rcm->nodeID.nxdata) - 1] == 1 && __nesc_ntoh_uint16(rcm->type.nxdata) == 2) {
                sim_log_debug(160U, "timer", "TYPE 2: SUBSCRIBE message received from node %d topic %d-------------------------------\n", __nesc_ntoh_uint16(rcm->nodeID.nxdata), __nesc_ntoh_uint16(rcm->topic.nxdata));
                rcm2 = (msg_t *)Project1C$Packet$getPayload(&Project1C$packet[sim_node()], sizeof(msg_t ));
                if (rcm2 == (void *)0) {
                    return bufPtr;
                  }
                __nesc_hton_uint16(rcm2->type.nxdata, 3);


                if (__nesc_ntoh_uint16(rcm->topic.nxdata) == 0) {
                    Project1C$subToTopic0[sim_node()][__nesc_ntoh_uint16(rcm->nodeID.nxdata) - 1] = 1;
                  }
                else {
#line 202
                  if (__nesc_ntoh_uint16(rcm->topic.nxdata) == 1) {
                      Project1C$subToTopic1[sim_node()][__nesc_ntoh_uint16(rcm->nodeID.nxdata) - 1] = 1;
                    }
                  else {
#line 204
                    if (__nesc_ntoh_uint16(rcm->topic.nxdata) == 2) {
                        Project1C$subToTopic2[sim_node()][__nesc_ntoh_uint16(rcm->nodeID.nxdata) - 1] = 1;
                      }
                    }
                  }
                sim_log_debug(161U, "timer", "PAN COORD tries to send SUBACK message\n");

                Project1C$Mysend(__nesc_ntoh_uint16(rcm->nodeID.nxdata), &Project1C$packet[sim_node()]);


                for (Project1C$i[sim_node()] = 0; Project1C$i[sim_node()] < 8; Project1C$i[sim_node()]++) {
                    if (((Project1C$subToTopic0[sim_node()][Project1C$i[sim_node()]] || Project1C$subToTopic1[sim_node()][Project1C$i[sim_node()]]) || Project1C$subToTopic2[sim_node()][Project1C$i[sim_node()]]) && (Project1C$subToTopic0[sim_node()][0] && Project1C$subToTopic1[sim_node()][0] && Project1C$subToTopic1[sim_node()][2] && Project1C$subToTopic2[sim_node()][2] && Project1C$subToTopic0[sim_node()][5] && Project1C$subToTopic1[sim_node()][5] && Project1C$subToTopic2[sim_node()][5])) {
                        endSub = TRUE;
                      }
                    else 
#line 217
                ...
                if (endSub) {
                    ...
                    __nesc_hton_uint16(rcm2->type.nxdata, 5);

                    Project1C$Mysend(AM_BROADCAST_ADDR, &Project1C$packet[sim_node()]);
                  }
              }
            else {

              if (Project1C$connections[sim_node()][__nesc_ntoh_uint16(rcm->nodeID.nxdata) - 1] == 1 && __nesc_ntoh_uint16(rcm->type.nxdata) == 4) {
                  sim_log_debug(162U, "timer", "TYPE 4: PUBLISH message received------------------------------------------------------\n");
                  ...
                  if (__nesc_ntoh_uint16(rcm->topic.nxdata) == 0) {
                      ...
                      for (Project1C$i[sim_node()] = 0; Project1C$i[sim_node()] < 8; Project1C$i[sim_node()]++) {
                          if (Project1C$subToTopic0[sim_node()][Project1C$i[sim_node()]] == 1) {

                              __nesc_hton_uint16(rcm2->type.nxdata, 4);
                              __nesc_hton_uint16(rcm2->value.nxdata, __nesc_ntoh_uint16(rcm->value.nxdata));
                              __nesc_hton_uint16(rcm2->topic.nxdata, 0);

                              Project1C$Mysend(Project1C$i[sim_node()] + 1, &Project1C$packet[sim_node()]);

                              sim_log_debug(163U, "timer", "FORWARDING on topic %d to subscriber %d--------------------------------------------\n", __nesc_ntoh_uint16(rcm->topic.nxdata), Project1C$i[sim_node()] + 1);
                            }
                        }
                    }
                  else {
#line 257
                    if (__nesc_ntoh_uint16(rcm->topic.nxdata) == 1) {
                        ...
                        for (Project1C$i[sim_node()] = 0; Project1C$i[sim_node()] < 8; Project1C$i[sim_node()]++) {
                            if (Project1C$subToTopic1[sim_node()][Project1C$i[sim_node()]] == 1) {

                                __nesc_hton_uint16(rcm2->type.nxdata, 4);
                                __nesc_hton_uint16(rcm2->value.nxdata, __nesc_ntoh_uint16(rcm->value.nxdata));
                                __nesc_hton_uint16(rcm2->topic.nxdata, 1);

                                Project1C$Mysend(Project1C$i[sim_node()] + 1, &Project1C$packet[sim_node()]);

                                sim_log_debug(164U, "timer", "FORWARDING on topic %d to subscriber %d--------------------------------------------\n", __nesc_ntoh_uint16(rcm->topic.nxdata), Project1C$i[sim_node()] + 1);
                              }
                          }
                      }
                    else {
#line 272
                      if (__nesc_ntoh_uint16(rcm->topic.nxdata) == 2) {
                          ...
                          for (Project1C$i[sim_node()] = 0; Project1C$i[sim_node()] < 8; Project1C$i[sim_node()]++) {
                              if (Project1C$subToTopic2[sim_node()][Project1C$i[sim_node()]] == 1) {

                                  __nesc_hton_uint16(rcm2->type.nxdata, 4);
                                  __nesc_hton_uint16(rcm2->value.nxdata, __nesc_ntoh_uint16(rcm->value.nxdata));
                                  __nesc_hton_uint16(rcm2->topic.nxdata, 2);

                                  Project1C$Mysend(Project1C$i[sim_node()] + 1, &Project1C$packet[sim_node()]);

                                  sim_log_debug(165U, "timer", "FORWARDING on topic %d to subscriber %d--------------------------------------------\n", __nesc_ntoh_uint16(rcm->topic.nxdata), Project1C$i[sim_node()] + 1);
                                }
                            }
                        }
                      }
                  ...
                  sim_log_debug(166U, "radio_rec", "Sending PUB messages to Node-RED\n");


                  sockfd = socket(2, SOCK_STREAM, 0);
                  if (sockfd == -1) 
                    {
                      sim_log_debug(167U, "error", "Socket creation failed!\n");
                      return bufPtr;
                    }
                  ...
                  if (connect(sockfd, (struct sockaddr *)&servaddr, sizeof servaddr) != 0) 
                    {
                      sim_log_debug(168U, "error", "Connection with the server failed!\n");
                      close(sockfd);
                      return bufPtr;
                    }
                  ...
                  if (send(sockfd, rcm, sizeof(msg_t ), 0) == -1) 
                    {
                      sim_log_debug(169U, "error", "Failed to send message!\n");
                      return bufPtr;
                    }
...
#line 327
        {
          if (__nesc_ntoh_uint16(rcm->type.nxdata) == 1) {
              sim_log_debug(170U, "timer", "TYPE 1: CONNACK message received------------------------------------------------------\n");
              ...
              if (TOS_NODE_ID == 1) {
                  __nesc_hton_uint16(rcm2->nodeID.nxdata, TOS_NODE_ID);
                  __nesc_hton_uint16(rcm2->topic.nxdata, 0);
                  __nesc_hton_uint16(rcm2->type.nxdata, 2);
                  Project1C$Mysend(0, &Project1C$packet[sim_node()]);
                  Project1C$numSub[sim_node()] = 1;
                }
              else {
#line 344
                if (TOS_NODE_ID == 3) {
...
#line 351
                  if (TOS_NODE_ID == 6) {
                      ...
                      __nesc_hton_uint16(rcm2->nodeID.nxdata, TOS_NODE_ID);
                      __nesc_hton_uint16(rcm2->topic.nxdata, Project1C$Random$rand16() % 3);
                      __nesc_hton_uint16(rcm2->type.nxdata, 2);
                      Project1C$Mysend(0, &Project1C$packet[sim_node()]);
                    }
                  }
...
#line 366
            if (__nesc_ntoh_uint16(rcm->type.nxdata) == 3) {
                sim_log_debug(171U, "timer", "TYPE 3: SUBACK message received------------------------------------------------------\n");
                ...
                if (TOS_NODE_ID == 1 && Project1C$numSub[sim_node()] < 2) {
                    __nesc_hton_uint16(rcm2->nodeID.nxdata, TOS_NODE_ID);
                    __nesc_hton_uint16(rcm2->topic.nxdata, 1);
                    __nesc_hton_uint16(rcm2->type.nxdata, 2);
                    Project1C$Mysend(0, &Project1C$packet[sim_node()]);
                    Project1C$numSub[sim_node()] = 2;
                  }
                else {
#line 381
                  if (TOS_NODE_ID == 3 && Project1C$numSub[sim_node()] < 2) {
                      __nesc_hton_uint16(rcm2->nodeID.nxdata, TOS_NODE_ID);
                      __nesc_hton_uint16(rcm2->topic.nxdata, 2);
                      __nesc_hton_uint16(rcm2->type.nxdata, 2);
                      Project1C$Mysend(0, &Project1C$packet[sim_node()]);
                    ...
                    if (TOS_NODE_ID == 6 && Project1C$numSub[sim_node()] < 3) {
                        __nesc_hton_uint16(rcm2->nodeID.nxdata, TOS_NODE_ID);
                        __nesc_hton_uint16(rcm2->topic.nxdata, Project1C$numSub[sim_node()]);
                        __nesc_hton_uint16(rcm2->type.nxdata, 2);
                        Project1C$Mysend(0, &Project1C$packet[sim_node()]);
                        Project1C$numSub[sim_node()]++;
                      }
                    }
                  }
              }
...
#line 399
              if (__nesc_ntoh_uint16(rcm->type.nxdata) == 5) {


                  if (TOS_NODE_ID == 1) {
                      Project1C$Timer1$startPeriodicAt(1000, 9000);
                    }
                  else {
#line 404
                    if (TOS_NODE_ID == 2) {
                        Project1C$Timer1$startPeriodicAt(2000, 9000);
                      }
                    else {
#line 406
                      if (TOS_NODE_ID == 3) {
                          Project1C$Timer1$startPeriodicAt(3000, 9000);
                        }
                      else {
#line 408
                        if (TOS_NODE_ID == 4) {
                            Project1C$Timer1$startPeriodicAt(4000, 9000);
                          }
                        else {
#line 410
                          if (TOS_NODE_ID == 5) {
                              Project1C$Timer1$startPeriodicAt(5000, 9000);
                            }
                          else {
#line 412
                            if (TOS_NODE_ID == 6) {
                                Project1C$Timer1$startPeriodicAt(6000, 9000);
                              }
                            else {
#line 414
                              if (TOS_NODE_ID == 7) {
                                  Project1C$Timer1$startPeriodicAt(7000, 9000);
                                }
                              else {
#line 416
                                if (TOS_NODE_ID == 8) {
                                    Project1C$Timer1$startPeriodicAt(8000, 9000);
                                  }
                                }
                              }
                            }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76e9298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76e9298) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76e9298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74950a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74950a0, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76f88b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76f88b0, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76e9930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76e9930, msg, payload, len);
#line 78
...
#line 72
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(151U, "radio", "Start done on node %d!\n", TOS_NODE_ID);



      if (TOS_NODE_ID == 0) {
          Project1C$Timer0$startOneShot(0);
        }
      else {
#line 81
        if (TOS_NODE_ID == 1) {
            Project1C$Timer0$startOneShot(1000);
          }
        else {
#line 83
          if (TOS_NODE_ID == 2) {
              Project1C$Timer0$startOneShot(2000);
            }
          else {
#line 85
            if (TOS_NODE_ID == 3) {
                Project1C$Timer0$startOneShot(3000);
              }
            else {
#line 87
              if (TOS_NODE_ID == 4) {
                  Project1C$Timer0$startOneShot(4000);
                }
              else {
#line 89
                if (TOS_NODE_ID == 5) {
                    Project1C$Timer0$startOneShot(5000);
                  }
                else {
#line 91
                  if (TOS_NODE_ID == 6) {
                      Project1C$Timer0$startOneShot(6000);
                    }
                  else {
#line 93
                    if (TOS_NODE_ID == 7) {
                        Project1C$Timer0$startOneShot(7000);
                      }
                    else {
#line 95
                      if (TOS_NODE_ID == 8) {
                          Project1C$Timer0$startOneShot(8000);
                        }
                      }
                    }
                  }
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74966a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74966a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74966a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb78a4650){
#line 75
  switch (arg_0xb78a4650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb78a4650);
#line 75
      break;
#line 75
    }
...
#line 110
{
  ...
  if (TOS_NODE_ID != 0) {
      ...
      sim_log_debug(154U, "timer", "TIMER FIRED node: %d\n", TOS_NODE_ID);
      ...
      __nesc_hton_uint16(rcm2->type.nxdata, 0);
      __nesc_hton_uint16(rcm2->nodeID.nxdata, TOS_NODE_ID);

      sim_log_debug(155U, "timer", "Node: %d tries to send CONNECT message\n", TOS_NODE_ID);
...
#line 133
    if (TOS_NODE_ID == 0) {
        sim_log_debug(156U, "timer", "PANCOORD IS ACTIVE\n");
      }
    }
}
...
#line 139
{
  ...
  __nesc_hton_uint16(rcm2->nodeID.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(rcm2->topic.nxdata, Project1C$Random$rand16() % 3);
  __nesc_hton_uint16(rcm2->value.nxdata, Project1C$Random$rand16() % 100);

  sim_log_debug(157U, "timer", "PUBLISH MESSAGE node:%d topic: %d value: %d------------------------------\n", TOS_NODE_ID, __nesc_ntoh_uint16(rcm2->topic.nxdata), __nesc_ntoh_uint16(rcm2->value.nxdata));
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73173a8){
#line 83
  switch (arg_0xb73173a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73173a8);
#line 83
      break;
#line 83
    }
...
#line 53
{
  ...
  if (Project1C$AMSend$send(a, p, sizeof(msg_t )) == SUCCESS) {
...
#line 426
{
  ...
  if (&Project1C$packet[sim_node()] == bufPtr) {
      sim_log_debug(172U, "radio_send", "Packet sent...");
      sim_log_debug_clear(173U, "radio_send", " at time %s \n", sim_time_string());
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Project1C$subToTopic0"))
  {
    *addr = (uintptr_t)&Project1C$subToTopic0[__nesc_mote];
    *size = sizeof(Project1C$subToTopic0[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$subToTopic1"))
  {
    *addr = (uintptr_t)&Project1C$subToTopic1[__nesc_mote];
    *size = sizeof(Project1C$subToTopic1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$subToTopic2"))
  {
    *addr = (uintptr_t)&Project1C$subToTopic2[__nesc_mote];
    *size = sizeof(Project1C$subToTopic2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$i"))
  {
    *addr = (uintptr_t)&Project1C$i[__nesc_mote];
    *size = sizeof(Project1C$i[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$numSub"))
  {
    *addr = (uintptr_t)&Project1C$numSub[__nesc_mote];
    *size = sizeof(Project1C$numSub[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Project1C$connections"))
  {
    *addr = (uintptr_t)&Project1C$connections[__nesc_mote];
    *size = sizeof(Project1C$connections[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memcpy((void *)&Project1C$subToTopic0[__nesc_mote], (void *)&(unsigned short [8]){ 0, 0, 0, 0, 0, 0, 0, 0 }, sizeof Project1C$subToTopic0[__nesc_mote]);
  memcpy((void *)&Project1C$subToTopic1[__nesc_mote], (void *)&(unsigned short [8]){ 0, 0, 0, 0, 0, 0, 0, 0 }, sizeof Project1C$subToTopic1[__nesc_mote]);
  memcpy((void *)&Project1C$subToTopic2[__nesc_mote], (void *)&(unsigned short [8]){ 0, 0, 0, 0, 0, 0, 0, 0 }, sizeof Project1C$subToTopic2[__nesc_mote]);
  Project1C$i[__nesc_mote] = 0;
  Project1C$numSub[__nesc_mote] = 0;
  memcpy((void *)&Project1C$connections[__nesc_mote], (void *)&(unsigned short [8]){ 0, 0, 0, 0, 0, 0, 0, 0 }, sizeof Project1C$connections[__nesc_mote]);
